...
namespace Dyscord
{
    ...
    public partial class DyscordForm : Form
    {
        ...
        public DyscordForm()
        {
            ...
            this.webBrowser1.DocumentCompleted += new WebBrowserDocumentCompletedEventHandler(WebBroswer1__DocumentCompleted);
        ...
        private void WebBroswer1__DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
