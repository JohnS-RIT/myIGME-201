...
{
    //Class: PeopleApp
    //Purpose: Display lots of information about a school system (teachers, courses, students, people, and their respective info)
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    ...
                    if (input.Length > 0)
                    {
                        thisStudent.courseCodes.Add(input);
                    }
                    else
                    {
                        break;
