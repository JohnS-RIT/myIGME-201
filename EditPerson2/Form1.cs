    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            this.froshRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__Changed);
            this.sophRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__Changed);
            this.juniorRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__Changed);
            this.seniorRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__Changed);
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if( person.GetType() == typeof( Student))
            {
                ...
                //student.eCollegeYear = this.classGroupBox.??
            }
            else
            {
